...
const openRepository = () => {
  window.location.assign('https://github.com/Pigeon-Ming/UniversalSend')
}
  ...
  <section class="product-page">
    <header class="product-hero" :class="isDarkMode ? 'theme-dark' : 'theme-light'">
      <div class="hero-content">
        <h1 class="hero-title">UniversalSend</h1>
        <p class="hero-description">UWP平台的第三方LocalSend客户端</p>
        <div class="hero-actions">
          
          <ms-store-badge
          	productid="9nlv610pv364"
